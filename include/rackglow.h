...
// Boot screen patch lead (the plugs; the cable's lit hues are the brand spectrum)
#define UI_COLOR_CABLE_SLEEVE   0x2E2E3A    // Unlit cable jacket
#define UI_COLOR_PLUG_METAL     0xB9C0C9    // Plug tip and sleeve
#define UI_COLOR_PLUG_METAL_DIM 0x70777F    // Plug metal in shadow
#define UI_COLOR_PLUG_BODY      0x323240    // Plug housing and strain relief
#define UI_COLOR_PLUG_BODY_DIM  0x1E1E28    // Plug housing in shadow
#define UI_COLOR_PLUG_BAND      0x0F0F14    // Plug insulator band
