 ...
 * in via setBuffer().
 *
 * Each animation keeps its OWN running state. Shared function-statics would
 * leak state from one animation into the next on every switch.
 */
