...
Four parts: the Eurorack front panel that carries the WT32-SC01 Plus, the MSGEQ7 protoboard, the
pot and the jack — plus a holder for the LED strip and two covers.

| File | Part | Size |
|---|---|---|
| `control-panel.stl` | Front panel, 14 HP × 3U | 70.8 × 128.5 × 15.0 mm |
